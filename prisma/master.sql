...
INSERT INTO `akun` (`nama`, `email`, `noTelp`, `roleId`, `password`, `foto`, `createdAt`, `updatedAt`) 
VALUES ('Admin ESWKA', 'admin@eswka.com', '081234567890', 1, '$argon2id$v=19$m=65536,t=3,p=4$hashedpassword', NULL, NOW(), NOW());